...
| Tabela de Gerenciamento de Riscos da LUNA Auto-Aplicada (Theory — primeira operacionalização real de V(s)/outcome, nomenclatura ISO/IEC 23894+42001, formalização de A(t)/A_politica(t)/Crescimento(t)) | `GENESIS/RESEARCH/luna-tabela-risco-iso-outcome.md` |
