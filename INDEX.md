...
| ADR-021 Extensão — Questionário por modelo (3 modelos extensíveis: Riscos Críticos, Procedimentos, 5S), painel de gestão (novo, sem código ainda), templates multi-página enviados pela empresa para a Fase 2 (`CONV-014`) (**Proposto — 3 pendências (P1-P3: escopo de PT, tipo de passivo trabalhista, sequenciamento) em aberto, bloqueiam qualquer instrução de Builder para esta extensão**) | `ADR/ADR-021-Extensao-Questionario-Painel-Gestao.md` |
