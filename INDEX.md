...
| ADR-021 Extensão — Questionário por modelo (3 modelos extensíveis: Riscos Críticos, Procedimentos, 5S), painel de gestão (novo, sem código ainda), templates multi-página enviados pela empresa para a Fase 2 (`CONV-014`) (**Pendências P1-P3 resolvidas — escopo técnico de Decisão 1/2 ainda por detalhar antes de instrução de Builder**) | `ADR/ADR-021-Extensao-Questionario-Painel-Gestao.md` |
